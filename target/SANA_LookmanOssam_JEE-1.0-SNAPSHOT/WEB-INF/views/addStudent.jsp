...
<section class="vh-100 bg-image"
  ...
  <div class="mask d-flex align-items-center h-100 gradient-custom-3">
            ...
            <div class="card-body p-5">
              ...
              <form action="saveStudent" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="cne" name="cne"  required class="form-control form-control-lg" />
                ...
                <div class="form-outline mb-4">
                  <input type="number" min="0" max="20" id="moyenne" name="moyenne" class="form-control form-control-lg" />
   ...
   <c:forEach items="${listfiliere}" var="v">
    <option  value="${v.getCodeFil()}">${v.getNomFil()}</option>
    </c:forEach>
</select>
