<%-- 
    Document   : addStudent
    Created on : 14 janv. 2023, 13:17:59
    Author     : lookman
--%>
            ...
            <div class="card-body p-5">
              ...
              <form action="UpdateStudent" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="cne" name="cne" value="${Eleve.getCne()}" readonly class="form-control form-control-lg" />
                  <label class="form-label" for="cne">CNE</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="text" id="nom" name="nom" value="${Eleve.getNom()}" class="form-control form-control-lg" />
                  <label class="form-label" for="nom">NOM</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="text" id="prenom" name="prenom" value="${Eleve.getPrenom()}" class="form-control form-control-lg" />
                  <label class="form-label" for="prenom">PRENOM</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="number" min="0" max="20" id="moyenne" name="moyenne" value="${Eleve.getMoyenne()}" class="form-control form-control-lg" />
                  <label class="form-label" for="moyenne">MOYENNE</label>
                </div>
                 
                    <div class="form-outline mb-4">
                  <!--<input type="text" id="filiere" name="refFil" value="${Eleve.getRefFil().getCodeFil()}" class="form-control form-control-lg" />-->
                  <select class="form-control form-control-lg" name="refFil" id="pet-select">
                       
    <option value="">--Please choose an option--</option>
   <c:forEach items="${listFiliere}" var="v">
    <option ${Eleve.getRefFil() != null && Eleve.getRefFil().getCodeFil() == v.getCodeFil() ? 'selected' : ''} value="${v.getCodeFil()}">${v.getNomFil()}</option>
    </c:forEach>
</select>
