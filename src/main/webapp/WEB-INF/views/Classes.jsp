...
<c:url value="/list" var="urlStudent"/>
<a href="${urlStudent}" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Accueil</span></a>
        </div>
...
<tr>
    ...
    <c:url value="DeleteFiliere" var="ClassC">
                <c:param name="codeFil" value="${v.getCodeFil()}"></c:param>
    </c:url>
   <c:url value="EditFiliere" var="ClassE">
                <c:param name="codeFil" value="${v.getCodeFil()}"></c:param>
    </c:url>
                    
  
   <td><c:out value="${v.getCodeFil()}"></c:out></td>
   <td><c:out value="${v.getNomFil()}"></c:out></td>
   
   <td>
<a href="${ClassE}"  class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
<a href="${ClassC}" class="delete" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
   </td>
</tr>
                </c:forEach>
                  <%--<%}
